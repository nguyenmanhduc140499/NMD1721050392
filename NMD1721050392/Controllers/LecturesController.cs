...
using NMD1721050392.Models;

namespace NMD1721050392.Controllers
{
    public class LecturesController : Controller
    {
        private NMD1721050392DBcontext db = new NMD1721050392DBcontext();
        ...
        {
            var lecID = "";
            var countLecture = db.Lectures.Count();
            if (countLecture == 0)
            {
                lecID = "LCT001";
            }
